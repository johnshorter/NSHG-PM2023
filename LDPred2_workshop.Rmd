...
This is taken from a tutorial by Florian Privé. 
https://privefl.github.io/bigsnpr/articles/LDpred2.html

Should we run out of time for this workshop, feel free to visit the tutorial by Florian, which inlcudes a youtube video.
...
## We then will read in our libraries
```{r}
library(bigsnpr)
library(ggplot2)
library(dplyr)
